...
RUN curl -SLO "https://github.com/just-containers/s6-overlay/releases/download/v2.2.0.3/s6-overlay-amd64.tar.gz" \
...
RUN apt-get update && apt-get install -y \
    curl libcairo2-dev libjpeg62-turbo-dev libpng-dev \
